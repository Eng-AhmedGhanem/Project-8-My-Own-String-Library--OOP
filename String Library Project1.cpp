...

{
	...
	clsString String2("Ali");

	String1.Value = "Ali Ghanem";
	...
	cout << "Number of words: " << String1.CountWords("ahmed rady omer mohmed") << endl;

	cout << "Number of words: " <<
		clsString::CountWords("Ahmed Abdulrahman Ghanem") << endl;
	...
	cout << "Capital Letters count : "
		<< clsString::CountLetters("Ahmed Ghanem", clsString::CapitalLetters)
		<< endl << endl;
	...
	String3.Value = "Ahmed Abdulrahman Ghanem";
	cout << "\n\nString     = " << String3.Value;
	...
	String3.Value = "Ahmed Abdulrahman Ghanem";
	cout << "\nReplace : ";
	String3.ReplaceWord("Khaled", "Maher");
	cout << String3.Value << endl;
